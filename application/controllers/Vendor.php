...
class Vendor extends CI_Controller
{
    ...
    function product($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        if ($para1 == 'do_add') {
            ...
            echo $this->crud_model->select_html('product', 'product', 'title', 'add', 'demo-chosen-select required', '', array('sub_category','added_by'), array($para2,'{"type":"vendor","id":"'.$this->session->userdata('vendor_id').'"}'), 'get_pro_res');
    ...
    function sales($para1 = '', $para2 = '')
    {
        ...
        if ($para1 == 'delete') {
            ...
            $page_data['sale'] = $this->db->get_where('sale', array('sale_id' => $para2))->row_array();
