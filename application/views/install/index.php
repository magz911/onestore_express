...
<head>
	...
	<title>intelmatics Tindahan</title>
            ...
            <div id="page-content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                                ...
                                <?php echo form_open(base_url().'index.php/install/do_install' , array('id' => 'demo-bv-wz-form' , 'class' => 'form-horizontal'));?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
                                                ...
                                                <p class="text-muted rmb" style="display:block;">
                                                	Thank you for installing "intelmatics Tindahan MarketPlace". Best wishes for the next 
                                                 	<h5>It takes about 2-3 Minutes</h5>
                                                 </p>
                                                ...
                                                <div class="ads" style="display:none;">
                                                    ...
                                                    <a class="btn btn-info" target="_blank" href="http://intelmatics.com/check/" style="margin-bottom:7px;">Activate</a>
                                    ...
                                    <div class="panel-footer text-right" style="background-color: #fff;">
                                        <div class="box-inline">
                                            ...
                                            <button type="button" class="finish btn btn-success submitter" disabled>Install Tindahan</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <center> 2015 &copy; All Rights Reserved @ <a href="about:blank">intelmatics Tindahan </a></center>
                    </div>
