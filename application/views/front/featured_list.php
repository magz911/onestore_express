                            ...
                            <ul class="list-unstyled checkbox-list">
                                ...
                                <li>
                                   <label class="checkbox">
                                        ...
                                        <small>(<?php echo $this->db->get_where('product',array('category'=>$row['category_id'], 'featured'=>"ok", 'status'=>'ok'))->num_rows(); ?>)</small>
                                    </label> 
                                </li>
                                <li>
                                    ...
                                    <li>
                                        <label class="checkbox">
                                            ...
                                            <small>(<?php echo $this->db->get_where('product',array('sub_category'=>$row1['sub_category_id'], 'featured'=>"ok", 'status'=>'ok'))->num_rows(); ?>)</small>
                                        </label>
                                    </li>
                                    <?php } ?>
                                    </ul>
                            ...
                            <ul class="list-unstyled checkbox-list">
                                ...
                                <?php
                                    ...
                                    foreach($vendors as $row){
                                        $seller_prod_count = $this->db->get_where('product',array('added_by'=>'{"type":"vendor","id":"'.$row['vendor_id'].'"}', 'featured'=>"ok", 'status'=>'ok'))->num_rows(); 
...
<input type="hidden" name="featured" id="featuredaa" value="ok">
<?php
    if($vendor_system == 'ok'){
?>
