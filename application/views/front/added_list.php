                ...
                <a href="<?php echo base_url(); ?>index.php/home/cart_checkout"><i class="fa fa-shopping-cart"></i></a>
                <span class="badge badge-sea rounded-x counter" id="counter"><?php echo count($carted); ?></span>
                <div class="badge-open">
                    <ul id="cart_ul" class="mCustomScrollbar list-unstyled" data-mcs-theme="minimal-dark">
                    <?php if(count($carted) > 0){ ?>
                        ...
                        <li>
                            ...
                            <button type="button" class="close remove_from_cart" data-rowid="<?php echo $items['rowid']; ?>" data-pid="<?php echo $items['id']; ?>">×</button>
                    ...
                    <div class="subtotal" id="subtotal">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="#" onClick="return false;" class="btn-u btn-brd btn-brd-hover btn-u-sea-shop btn-block" id="empty"><?php echo translate('empty_cart');?></a>
                            </div>
                            <div class="col-xs-6">
                                <a href="<?php echo base_url(); ?>index.php/home/cart_checkout" class="btn-u btn-u-sea-shop btn-block"><?php echo translate('checkout');?></a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
