...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/css/footers/footer-v1.css">

    <!-- CSS Implementing Plugins -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/animate.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/line-icons/line-icons.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/font-awesome-4.6.3/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/noUiSlider.8.5.1/nouislider.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/jquery-steps/css/custom-jquery.steps.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/scrollbar/css/jquery.mCustomScrollbar.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/sky-forms-pro/skyforms/css/sky-forms.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/sky-forms-pro/skyforms/custom/custom-sky-forms.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/master-slider/quick-start/masterslider/style/masterslider.css">
    <link rel='stylesheet' href="<?php echo base_url(); ?>template/front/assets/plugins/master-slider/quick-start/masterslider/skins/default/style.css">

    <!-- JS Optional -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/brand-buttons/brand-buttons.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/brand-buttons/brand-buttons-inversed.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/fancybox/source/jquery.fancybox.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/plugins/share/jquery.share.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/css/pages/blog.css">  
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/css/pages/profile.css"> 
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/css/pages/page_invoice.css">

    <!-- CSS Theme -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/assets/css/theme-colors/teal.css" id="style_color">
