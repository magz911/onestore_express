<!--=== Product Content ===-->
    <div class="container content-md ">
        ...
        <div class="row margin-bottom-60 ">
            <div class="heading heading-v4 margin-bottom-20">
                <h2><?php echo translate('products_by_sector'); ?></h2>
                <!--<p></p>-->
            </div>
            <?php
                $n = 0;
            ...
            ?>
                ...
                <div class="tab-v2 ">
                    <ul class="nav nav-tabs">
                        <li>
                            <div onClick="return false;" class="bg-warning font-weight-bold22 text-uppercase cpm_border22" data-toggle="tab">
                                <h5><i class="fa fa-tags"></i><?php echo $this->crud_model->get_type_name_by_id('category',$row,'category_name'); ?> &nbsp;</h5>
                            </div>
                        </li>
                        <?php
                            $l = 0;
                    ...
                    <?php } ?>
                        <li class="thumb-product-purchase">
                            ...
                            <?php if($this->crud_model->is_wished($row2['product_id'])=='yes'){ ?>
                                <a data-original-title="<?php echo translate('added_to_wishlist');?>" data-type='icon' data-toggle="tooltip" data-placement="left" data-pid='<?php echo $row2['product_id']; ?>' class="tooltips wished_it" href="#"><i class="fa fa-heart"></i></a>
                            <?php } else { ?>
                                <a data-original-title="<?php echo translate('add_to_wishlist');?>" data-type='icon' data-toggle="tooltip" data-placement="left" data-pid='<?php echo $row2['product_id']; ?>' class="tooltips wish_it" href="#"><i class="fa fa-heart-o"></i></a>
                            <?php } ?>
                        </li>
                    </ul>    
                </div>
                    ...
                    <?php } ?>
                        <li class="thumb-product-purchase">
                            ...
                            <?php if($this->crud_model->is_wished($now->product_id)=='yes'){ ?>
                                <a data-original-title="<?php echo translate('added_to_wishlist');?>" data-type='icon' data-toggle="tooltip" data-placement="left" data-pid='<?php echo $now->product_id; ?>' class="tooltips wished_it" href="#"><i class="fa fa-heart"></i></a>
                            <?php } else { ?>
                                <a data-original-title="<?php echo translate('add_to_wishlist');?>" data-type='icon' data-toggle="tooltip" data-placement="left" data-pid='<?php echo $now->product_id; ?>' class="tooltips wish_it" href="#"><i class="fa fa-heart-o"></i></a>
                            <?php } ?>
                        </li>
                    </ul>    
                </div>
