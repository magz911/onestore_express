<!--=== Product Content ===-->
    <div class="container content-md">
        ...
        <div class="row margin-bottom-20">
            ...
            ?>
                <div><h3 class="heading-sm"><i class="fa fa-hashtag"></i><?php echo $this->crud_model->get_type_name_by_id('category',$row,'category_name'); ?></h3></div>
                <!-- Tab v2 -->               
                <div class="tab-v1 margin-bottom-30">
