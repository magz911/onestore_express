...
?>
    ...
    <div class="shop-product">
        ...
        <!-- Breadcrumbs v5 -->
        <div class="container product_head22">
        ...
        <div class="container product_body22">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    ?>
                    <?php
                        $all_color = json_decode($row['color']);
                            if($all_color){
                    ?>
                    ...
                    <ul class="list-inline product-color margin-bottom-30">
                        ...
                        ?>
                            <li>
                                <input type="radio" id="color-<?php echo $i; ?>" value="<?php echo $p; ?>" <?php echo $color; ?> name="color">
                                <label style="background:<?php echo $p; ?>;width:50px;height:50px;" for="color-<?php echo $i; ?>"></label>
                            </li>  
                        <?php
                                }
                            }
