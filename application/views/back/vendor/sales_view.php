...
<?php
    if(isset($sale) && $this->crud_model->is_sale_of_vendor($sale['sale_id'],$this->session->userdata('vendor_id'))){
        $buyer = $sale['buyer'];
                        ...
                        <div class="row invoice-header">
                            ...
                            <div class="col-xs-6 invoice-numb">
                                <ul class="list-unstyled">
                                    <li><strong><?php echo translate('invoice_no');?></strong> : <?php echo $sale['sale_code'];?>/<?php echo $this->session->userdata('vendor_id'); ?></li>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="tag-box tag-box-v4">
                                    ...
                                    <ul class="list-unstyled">       
                                        <li><strong><?php echo translate('payment_status');?> :</strong> <i><?php echo translate($this->crud_model->sale_payment_status($sale['sale_id'],'vendor',$this->session->userdata('vendor_id'))); ?></i></li>
