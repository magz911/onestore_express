                    ...
                    <div class="tab-content">
                                    ...
                                    <select class="demo-chosen-select" name="package">
                                        <?php 
                                            foreach ($package_arr as $package){
                                                echo '<option value="' . $package["id"] . '">' . $package["label"] . ' | ' . $package["max_weight"] . 'kg | ' . currency() . $package["price"] .'</option>';
                                            } ?>
                                    </select>
                                </div>  
                            </div>
                        ...
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="form-control" data-height="200" data-name="description"></textarea>
                                </div>
                            </div>
