                    ...
                    <div class="tab-content">
                        ...
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="form-control" data-height="200" data-name="summery"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="form-control" data-height="300" data-name="description"></textarea>
                                </div>
                            </div>
