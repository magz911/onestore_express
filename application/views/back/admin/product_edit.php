                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="form-control" data-height="200" data-name="description">
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <?php
                                $package_arr = $this->crud_model->cpm_package('onestore');
                            ?>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-11"><?php echo translate('package');?></label>
                                <div class="col-sm-4">
                                    <select class="demo-chosen-select" name="package">
                                        <?php 
                                            foreach ($package_arr as $package){
                                                $package_id = $package["id"];
                                                $package_label = $package["label"];
                                                $package_max_weight = $package["max_weight"];
                                                $package_price = $package["price"];
                                                if ($row['package'] == $package_id){
                                                    echo '<option value="' . $package_id . '" selected>' . $package_label . ' | ' . $package_max_weight . 'kg | ' . currency() . $package_price .'</option>';
                                                }
                                                else{
                                                    echo '<option value="' . $package_id . '" >' . $package_label . ' | ' . $package_max_weight . 'kg | ' . currency() . $package_price .'</option>';
                                                }
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-11">
                     ...
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-save pull-right" onclick="form_submit('product_edit','<?php echo translate('successfully_edited!'); ?>');proceed('to_add');" ><?php echo translate('save');?></span> 
                     </div>
                </div>
            </div>
        </form>
